...
def main():
    parser = argparse.ArgumentParser(description="Ultimate Tic-Tac-Toe RL Model Evaluation (Masked)")
    parser.add_argument("--model", type=str, default="models/policy_masked.zip", 
    ...
    parser.add_argument("--use-mask", action="store_true", 
                        help="Use action masking during evaluation")
